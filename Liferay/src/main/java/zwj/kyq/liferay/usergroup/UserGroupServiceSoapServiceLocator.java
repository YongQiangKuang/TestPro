...
public class UserGroupServiceSoapServiceLocator extends org.apache.axis.client.Service implements zwj.kyq.liferay.usergroup.UserGroupServiceSoapService {
    ...
    public zwj.kyq.liferay.usergroup.UserGroupServiceSoap getPortal_UserGroupService() throws javax.xml.rpc.ServiceException {
    ...
    public zwj.kyq.liferay.usergroup.UserGroupServiceSoap getPortal_UserGroupService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            zwj.kyq.liferay.usergroup.Portal_UserGroupServiceSoapBindingStub _stub = new zwj.kyq.liferay.usergroup.Portal_UserGroupServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (zwj.kyq.liferay.usergroup.UserGroupServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                zwj.kyq.liferay.usergroup.Portal_UserGroupServiceSoapBindingStub _stub = new zwj.kyq.liferay.usergroup.Portal_UserGroupServiceSoapBindingStub(new java.net.URL(Portal_UserGroupService_address), this);
                _stub.setPortName(getPortal_UserGroupServiceWSDDServiceName());
                return _stub;
            }
        }
